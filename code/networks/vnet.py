...
# class MLPDimensionReducer(nn.Module):
#     def __init__(self, input_dim, output_dim):
#         super(MLPDimensionReducer, self).__init()
...
class VNet(nn.Module):
    def __init__(self, n_channels=1, n_classes=2, n_filters=16, normalization='none', has_dropout=False):
        ...
        # self.fc1 = nn.Linear(128 * 14 * 14 * 1, 512)  # You can adjust the hidden layer size
        # self.fc2 = nn.Linear(512, 10000)
        # self.fc3=nn.Linear(10000, 4 * 128 * 14 * 14 * 1)
